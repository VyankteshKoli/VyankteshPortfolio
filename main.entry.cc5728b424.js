...
function Ft(e) {
    ...
    return {
        c() {
            ...
            r = m("source"),
            s = m("source"),
            r.src !== (o = "channel-" + e[4].displayName + ".webm") && y(r, "src", o),
            y(r, "type", "video/webm"),
            s.src !== (i = "channel-" + e[4].displayName + ".mp4") && y(s, "src", i),
            y(s, "type", "video/mp4"),
            y(n, "class", "tv-video"),
        ...
        p(t, [e]) {
            16 & e && r.src !== (o = "channel-" + t[4].displayName + ".webm") && y(r, "src", o),
            16 & e && s.src !== (i = "channel-" + t[4].displayName + ".mp4") && y(s, "src", i),
...
function Kt(e) {
    ...
    return {
        c() {
            ...
            K = v(),
            Q = m("div"),
            Q.innerHTML = '<img loading="lazy" src="kiwivision.svg" alt="kiwivision" width="103" height="10" class="svelte-1vrpccc"/> \n          <br/> \n          <span>COMPUTER SPACE COMMAND</span>',
